...
const MAP_MARKER_SELECTOR = '.mapboxgl-marker, .maplibregl-marker, [data-trek-map-marker]';
...
function createMarkerElement(
  ...
  wrap.dataset.trekMapMarker = 'true';
...
export function MapViewGL({
  ...
  useEffect(() => {
    ...
    map.on('click', (e) => {
      ...
      if (t.closest(MAP_MARKER_SELECTOR)) return; // markers handle their own click
    ...
    const onTouchStart = (ev: TouchEvent) => {
      ...
      if ((ev.target as HTMLElement).closest(MAP_MARKER_SELECTOR)) return;
