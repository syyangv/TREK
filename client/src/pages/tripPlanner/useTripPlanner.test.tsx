...
describe('useTripPlanner — tabs', () => {
  ...
  it('FE-TP-HOOK-109: a requested collab tab survives until the addon feed answers', async () => {
    ...
    // Collab is intentionally hidden for solo trips; this exercises the
    // addon-loading race for a trip that has a companion.
    vi.mocked(tripsApi.getMembers).mockResolvedValue({
      owner: { id: 1, username: 'owner', avatar_url: null } as never,
      members: [{ id: 2, username: 'friend', avatar_url: null }],
    } as never)
