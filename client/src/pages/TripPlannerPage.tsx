            ...
            <div className="hidden md:block" style={{ position: 'absolute', left: 10, top: 10, bottom: 10, zIndex: 20 }}>
              ...
              <div style={{
                ...
                <DayPlanSidebar
                  isMobile={isMobile}
                  isTouch={isTouch}
                  initialExpandedDayIds={expandedDayIds}
                  tripId={tripId}
                  trip={trip}
                  days={days}
                  places={places}
