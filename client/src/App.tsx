...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (config?.version) {
      // Workbox owns the service-worker update lifecycle. Do not clear caches or
      // unregister workers here: offline map tiles and the user-controlled
      // UpdateBanner flow must survive an application-version change.
