...
export default function MAdminMcpTokensPanel() {
  ...
  const formatAdminDate = (value: string) => new Date(value.replace(/Z$/, '')).toLocaleDateString(locale)
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-[3px] flex flex-wrap items-center gap-x-2 gap-y-[2px] font-geist text-[0.625rem] text-m-muted">
                      ...
                      <span>{formatAdminDate(session.created_at)}</span>
                    </div>
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-[3px] flex flex-wrap items-center gap-x-2 gap-y-[2px] font-geist text-[0.625rem] text-m-muted">
                    ...
                    <span className="text-m-faint">·</span>
                    <span>{formatAdminDate(token.created_at)}</span>
                    <span className="text-m-faint">·</span>
                    <span>
                      {token.last_used_at
                        ? formatAdminDate(token.last_used_at)
