...
function formatAdminDate(value: string, locale: string): string {
  // API timestamps represent calendar values at UTC midnight. Parse them as a
  // local wall-clock value so western time zones do not show the prior day.
  return new Date(value.replace(/Z$/, '')).toLocaleDateString(locale)
}
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-[2px] truncate font-geist text-[0.59375rem] text-m-muted">
                    ...
                    {inv.expires_at && ` · ${t('admin.invite.expiresAt')} ${formatAdminDate(inv.expires_at, locale)}`}
