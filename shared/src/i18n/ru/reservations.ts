...
const reservations: TranslationStrings = {
  ...
  'reservations.alsoAddToDay': 'Также добавить это место в {day}',
  'reservations.alsoAddToDayHint': 'Без остановки в этот день место останется в списке как незапланированное.',
