...
const reservations: TranslationStrings = {
  ...
  'reservations.alsoAddToDay': 'Añadir también este lugar a {day}',
  'reservations.alsoAddToDayHint': 'Sin una parada ese día, el lugar sigue apareciendo como no planificado.',
