...
const reservations: TranslationStrings = {
  ...
  'reservations.alsoAddToDay': 'Diesen Ort auch zu {day} hinzufügen',
  'reservations.alsoAddToDayHint': 'Ohne Stopp an diesem Tag bleibt der Ort als ungeplant gelistet.',
