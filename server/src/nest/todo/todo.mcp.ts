...
export class TodoMcp {
  ...
  async createTodo(
    { tripId, name, category, start_date, due_date, description, assigned_user_id, priority }: {
      tripId: number; name: string; category?: string; start_date?: string; due_date?: string; description?: string; assigned_user_id?: number; priority?: number;
    },
    ctx: McpContext,
  ) {
    ...
    const item = this.todos.createItem(tripId, { name, category, start_date, due_date, description, assigned_user_id, priority });
  ...
  async updateTodo(
    { tripId, itemId, name, category, start_date, due_date, description, assigned_user_id, priority }: {
      tripId: number; itemId: number; name?: string; category?: string; start_date?: string | null; due_date?: string | null; description?: string | null; assigned_user_id?: number | null; priority?: number | null;
    },
    ctx: McpContext,
  ) {
    if (this.auth.isDemoUser(ctx.userId)) return demoDenied();
    ...
    const item = this.todos.updateItem(tripId, itemId, { name, category, start_date, due_date, description, assigned_user_id, priority }, bodyKeys);
